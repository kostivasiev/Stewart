    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron text-center">
                ...
                <p class="lead">
                    Welcome back to Equipment Manager Admin
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <table class="table">
              ...
              <tbody>
                @foreach( App\FuelStation::all() as $fuel_station)
                  @foreach( $fuel_station->pumps()->get() as $fuel_pump)
                  <tr>
              ...
              <tbody>
                @foreach( App\FuelStation::all() as $fuel_station)
                  ...
                  <tr>
                    ...
                    <td>{{ $fuel_pump->tank_logs()->orderBy('created_at', 'desc')->first()->current_gallons }}</td>
                  </tr>
                  @endforeach
                @endforeach
              </tbody>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <table class="table">
              ...
              <tbody>
                @foreach( App\LoginAccount::all() as $account)
                  <tr>
                    <td>{{ $account->name }}</td>
                    <td>{{ $account->count() }}</td>
                  </tr>
              ...
              <tbody>
                @foreach( App\FuelGroup::all() as $account)
                  <tr>
                    <td>{{ $account->name }}</td>
                    <td>{{ $account->count() }}</td>
                  </tr>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <table class="table">
              ...
              <tbody>
                @foreach( App\EquipmentType::all() as $account)
                  <tr>
                    <td>{{ $account->name }}</td>
                    <td>{{ $account->count() }}</td>
                  </tr>
